...
@Using (Html.BeginForm("Create", "Noticias", FormMethod.Post, New With {.enctype = "multipart/form-data", .id = "CreateNoticias"}))

    @Html.AntiForgeryToken()

    @<div class="card bg-white">
        <div class="card-header">
            <button type="button" class="btn btn-success" id="postGuardaNoticia">Guardar Noticia</button>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                @Html.DropDownList("idTipoNoticia", Nothing, String.Empty, New With {.class = "form-control", .placeholder = "Mes Inicial"})
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                @Html.TextBoxFor(Function(model) model.FechaInicio, New With {.type = "date", .class = "form-control"})
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                @Html.TextBoxFor(Function(model) model.FechaFin, New With {.type = "date", .class = "form-control"})
