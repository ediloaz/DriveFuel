...
<div>
    @For Each item In Model
      @<div style="page-break-after: always;" class="main-content">
      <div class="card card-block bg-white no-border" style="overflow: hidden;">
        <div class="row fila">
            <div class="col-xs-3 contenedor_usuario">
                <h3>@item.Nombre</h3>
                <h3>Grupos: @item.GruposCount</h3>
                <h3>Rutas @item.RutasCount</h3>
            </div>
            <div class="col-xs-2">
    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            @For Each respuesta As FormaRespuesta In item.FormaRespuesta
